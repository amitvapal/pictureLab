...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorTempleOld()
	{
		...
		System.out.println("It iterated " + count + " times.");
	}
  ...
  public void myCollage()
	{
		// 72x41
	Picture obito = new Picture("obito.png");
		// 65x308 -> 120x400
	Picture kakashi = new Picture("might_guy.jpg");
	// 78x107 -> 202x352
	Picture guy = new Picture("kakashi.jpeg");

	this.copy(obito, 0, 0);
	obito.mirrorDiagonal();
	this.copy(obito, 100, 0);
	//kakashi.zeroBlue();
	this.copyPartial(kakashi, 200, 0, 65, 308, 120, 400);
	guy.grayscale();
	this.copyPartial(guy, 300, 0, 78, 107, 202, 352);
	this.mirrorVertical();
	}
